      ...
      <div className="flex">
        <footer className="flex-1 bg-black">
          <div className="container flex flex-col items-center px-8 py-8 mx-auto max-w-7xl sm:flex-row">
            <a
              href="#_"
              className="text-xl font-black leading-none select-none logo text-green-500"
            >
              dev.Josan<span className="text-indigo-600">.</span>
            </a>
            <p className="mt-4 text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l sm:border-gray-200 sm:mt-0">
              © 2023 SpotiStat Gelu-Samuel Josan
            </p>
            <p></p>
            <span className="inline-flex justify-center mt-4 space-x-5 sm:ml-auto sm:mt-0 sm:justify-start">
              <a
                href="https://www.facebook.com/gelu.josan"
              ...
              <a
                href="https://www.instagram.com/samijosan/"
                className="text-gray-400 hover:text-gray-500"
              >
              ...
              <a
                href="https://www.linkedin.com/in/samueljosan/"
                className="text-gray-400 hover:text-gray-500"
              >
